...
import com.fooddelivery.module.PayPalConfig;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	        ...
	        try {
	            Payment payment = payPalService.createPayment(
	                ...
	                "http://localhost:9080/food_Delivery_app/cancel", // Cancel URL
	                "http://localhost:9080/food_Delivery_app/execute-payment" // Success URL
	            );
